...
export declare type ProjectStatus = 'ALL' | 'SUBSCRIBABLE' | 'UNSUBSCRIBABLE';
export declare type ProjectType = 'ACTIVITY' | 'CUSTOMIZED_FIXED';
export declare type ProjectSortBy = 'START_TIME' | 'LOT_SIZE' | 'INTEREST_RATE' | 'DURATION';
...
export declare type LendingType = 'DAILY' | 'ACTIVITY' | 'CUSTOMIZED_FIXED';
